...
MLA_BLOCK = 8576
MLA_PAGE = 4_390_912  # 8576 * 512 B/token (hades GB300 fp8 MLA geometry)
...
AVAIL = 8_000_000_000  # hades GB300 headroom
...
assert d0.block_size == 4288, d0.block_size  # 4,390,912 // 1024
...
assert view[67].data_ptr() - view[0].data_ptr() == MLA_PAGE  # mgr block 1 (4288//64=67)
